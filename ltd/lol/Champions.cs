...
{
    /// <summary>
    /// Danh sách tất cả các tướng Liên Minh Huyền Thoại (cập nhật theo dữ liệu lmssplus.org)
    /// </summary>
    ...
    /// <summary>
    /// Helper class để làm việc với Champion
    /// </summary>
    public static class ChampionHelper
    {
        /// <summary>
        /// Danh sách tất cả tướng dưới dạng string
        /// </summary>
        public static readonly IReadOnlyList<string> AllChampionNames = new List<string>
        {
            ...
            "MissFortune", "MonkeyKing", "Mordekaiser", "Morgana", "Naafiri", "Nami", "Nasus",
        ...
        public static string GetDisplayName(this Champion champion)
        {
            return champion.ToString(); // Có thể format đẹp hơn nếu cần (ví dụ: Aurelion Sol)
        }
    }
}